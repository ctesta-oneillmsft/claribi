...
#### [Module 00: Lab environment setup](Instructions/Labs/00/README.md)

Complete the lab environment setup for this course.

#### [Module 01: Explore compute and storage options for data engineering workloads](Instructions/Labs/01/README.md)
...
#### [Module 02: Run interactive queries using Azure Synapse Analytics serverless SQL pools](Instructions/Labs/04/README.md)
...
#### [Module 03: Data Exploration and Transformation in Azure Databricks](Instructions/Labs/06/README.md)
...
#### [Module 04: Explore, transform, and load data into the Data Warehouse using Apache Spark](Instructions/Labs/05/README.md)
...
#### [Module 05: Ingest and load data into the data warehouse](Instructions/Labs/07/README.md)
...
#### [Module 06: Transform data with Azure Data Factory or Azure Synapse Pipelines](Instructions/Labs/08/README.md)
...
#### [Module 07: Integrate data from Notebooks with Azure Data Factory or Azure Synapse Pipelines](Instructions/Labs/09/README.md)
...
#### [Module 08: End-to-end security with Azure Synapse Analytics](Instructions/Labs/13/README.md)
...
#### [Module 09: Support Hybrid Transactional Analytical Processing (HTAP) with Azure Synapse Link](Instructions/Labs/12/README.md)
...
### Day 4
#### [Module 10: Real-time Stream Processing with Stream Analytics](Instructions/Labs/14/README.md)
...
#### [Module 11: Create a Stream Processing Solution with Event Hubs and Azure Databricks](Instructions/Labs/15/README.md)
